            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{-- girdiğimiz bilgileri post ederek kayıt işlemini gerçekleştiren route adresini bu actiona yazcaz. --}}
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('kullanici.kaydol') }}">
                        {{ csrf_field() }}
                            {{-- old ile form içerisindeki verilerin girldikten sonra hata gelse  bile text alanında kayıtlı kalması sağlanacak. --}}
