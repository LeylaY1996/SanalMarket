            ...
            <div class="col-md-6">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <!--ufak dairelerin göründüğü carousel slide-->
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item {{ $index==0 ? 'active' : '' }} ">
                            <img src="http://via.placeholder.com/400x485?text=UrunResmi" alt="...">
                            <div class="carousel-caption">
                                {{--urundetay.phpdeki urun fonknun içinden urunadini getir--}}
                                {{$urun->urun_adi}} 
                            </div>
                        </div>
                        @endforeach
